...
SECRET_KEY = 'django-insecure-82h@q1cc%xu1ivs))t3c1ywv_2en++cv)6bhiw!5mkl=jq*8o6'
...
DJOSER = {
    ...
    'SEND_ACTIVATION_EMAIL': bool(int(os.environ.get('SEND_ACTIVATION_EMAIL', default=0))),
    'SERIALIZERS': {},
}
